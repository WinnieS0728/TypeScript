...
function contours_default() {
  ...
  function isorings(values, value, callback) {
    var fragmentByStart = new Array(), fragmentByEnd = new Array(), x4, y4, t02, t12, t22, t32;
    x4 = y4 = -1;
...
function transformer4() {
  var x06 = 0, x12 = 0.5, x22 = 1, s2 = 1, t02, t12, t22, k10, k21, interpolator = identity2, transform2, clamp = false, unknown;
  function scale2(x4) {
  ...
  scale2.domain = function(_) {
    return arguments.length ? ([x06, x12, x22] = _, t02 = transform2(x06 = +x06), t12 = transform2(x12 = +x12), t22 = transform2(x22 = +x22), k10 = t02 === t12 ? 0 : 0.5 / (t12 - t02), k21 = t12 === t22 ? 0 : 0.5 / (t22 - t12), s2 = t12 < t02 ? -1 : 1, scale2) : [x06, x12, x22];
  };
  scale2.clamp = function(_) {
    return arguments.length ? (clamp = !!_, scale2) : clamp;
  };
  ...
  return function(t) {
    transform2 = t, t02 = t(x06), t12 = t(x12), t22 = t(x22), k10 = t02 === t12 ? 0 : 0.5 / (t12 - t02), k21 = t12 === t22 ? 0 : 0.5 / (t22 - t12), s2 = t12 < t02 ? -1 : 1;
    return scale2;
  };
}
function diverging() {
...
function arc_default() {
  ...
  function arc() {
    ...
    if (!(r1 > epsilon8))
      ...
      var a01 = a0, a11 = a1, a00 = a0, a10 = a1, da0 = da2, da1 = da2, ap = padAngle.apply(this, arguments) / 2, rp = ap > epsilon8 && (padRadius ? +padRadius.apply(this, arguments) : sqrt3(r0 * r0 + r1 * r1)), rc = min3(abs4(r1 - r0) / 2, +cornerRadius.apply(this, arguments)), rc0 = rc, rc1 = rc, t02, t12;
      if (rp > epsilon8) {
